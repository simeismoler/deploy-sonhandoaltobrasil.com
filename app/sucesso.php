								...
								<div class="portfolio-image">
									...
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											...
											<a href="#myModal1" data-lightbox="inline" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"  title="Image"><i class="icon-line-circle-plus"></i></a>
										</div>
										<div class="bg-overlay-bg dark" data-hover-animate="fadeIn"></div>
									</div>
									<!-- Overlay: End -->
...
Fisioterapeuta na área clínica, pela cidade de Imperatriz/MA, atendendo pacientes com déficits neurológicas
						...
						<article class="portfolio-item col-lg-3 col-md-4 col-sm-6 col-12 pf-formados">
								...
								<div class="portfolio-image">
									...
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											...
											<a href="#myModal_tarcila" data-lightbox="inline" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"  title="Image"><i class="icon-line-circle-plus"></i></a>
										</div>
										<div class="bg-overlay-bg dark" data-hover-animate="fadeIn"></div>
									</div>
									<!-- Overlay: End -->
							...
							<!-- Grid Inner: End -->
							<!-- Modal -->
                            <div class="modal1 mfp-hide" id="myModal_tarcila">
                                <div class="block mx-auto" style="background-color: #FFF; max-width: 500px;">
                                    <div class="feature-box fbox-center fbox-effect fbox-lg border-bottom-0 mb-0" style="padding: 40px;">
...
Grande parte das minhas conquistas eu devo a Colportagem, de maneira especial ao projeto sonhando alto, que me deu oportunidade de me preparar melhor tanto no sentido de ter certeza do que eu gostaria de me tornar como profissional como de desenvolver melhor as habilidade necessárias para colportar nas férias e alcançar os alvos que eu precisava. O projeto sonhando é uma oportunidade de se preparar e se aperfeiçoar.</span>
						...
						<article class="portfolio-item col-lg-3 col-md-4 col-sm-6 col-12 pf-estudantes">
								...
								<div class="portfolio-image">
									...
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											...
											<a href="#myModal_balbino" data-lightbox="inline" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"  title="Image"><i class="icon-line-circle-plus"></i></a>
										</div>
										<div class="bg-overlay-bg dark" data-hover-animate="fadeIn"></div>
									</div>
									<!-- Overlay: End -->
							...
							<!-- Grid Inner: End -->
							<!-- Modal -->
                            <div class="modal1 mfp-hide" id="myModal_balbino">
                                <div class="block mx-auto" style="background-color: #FFF; max-width: 500px;">
                                    <div class="feature-box fbox-center fbox-effect fbox-lg border-bottom-0 mb-0" style="padding: 40px;">
						...
						<article class="portfolio-item col-lg-3 col-md-4 col-sm-6 col-12 pf-formados">
								...
								<div class="portfolio-image">
									...
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											...
											<a href="#myModal_thacio" data-lightbox="inline" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"  title="Image"><i class="icon-line-circle-plus"></i></a>
										</div>
										<div class="bg-overlay-bg dark" data-hover-animate="fadeIn"></div>
									</div>
									<!-- Overlay: End -->
							...
							<!-- Grid Inner: End -->
							<!-- Modal -->
                            <div class="modal1 mfp-hide" id="myModal_thacio">
                                <div class="block mx-auto" style="background-color: #FFF; max-width: 500px;">
                                    <div class="feature-box fbox-center fbox-effect fbox-lg border-bottom-0 mb-0" style="padding: 40px;">
...
Participei do sonhando alto com intuito de conseguir uma bolsa e estudar em uma faculdade. Logo me apaixonei por essa obra. Aprendi a me comunicar melhor, a importância de persistir, me relacionar melhor com as pessoas e tive uma experiência mais profunda com Deus. Hoje, sou Diretora de uma escola na cidade que eu nasci e sou agradecida por tudo que Deus me deu na colportagem.</span>
						...
						<article class="portfolio-item col-lg-3 col-md-4 col-sm-6 col-12 pf-formado">
								...
								<div class="portfolio-image">
									...
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											...
											<a href="#myModal_lucas" data-lightbox="inline" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"  title="Image"><i class="icon-line-circle-plus"></i></a>
										</div>
										<div class="bg-overlay-bg dark" data-hover-animate="fadeIn"></div>
									</div>
									<!-- Overlay: End -->
							...
							<!-- Grid Inner: End -->
							<!-- Modal -->
                            <div class="modal1 mfp-hide" id="myModal_lucas">
                                <div class="block mx-auto" style="background-color: #FFF; max-width: 500px;">
                                    <div class="feature-box fbox-center fbox-effect fbox-lg border-bottom-0 mb-0" style="padding: 40px;">
